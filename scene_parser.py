...
class SceneParser:
    ...
    def __init__(self, path: str):
        data = self._load(path) #restituisce dizionario grezzo
        #esegue controlli e salva negli attributi 
        self.transparent_index = self._func_transparent_index(data) #numero
        self.tile_map          = self._func_tile_map(data) 
        self.sprites           = self._func_sprites(data)
    """
    ...
    def _func_tile_map(self, data: dict):     
        ...
        #controllo ogni riga della lista
